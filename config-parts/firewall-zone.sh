...
set firewall zone unifi-mgmt-900 interface 'eth1.900'
...
set firewall zone unifi-frontend-910 interface 'eth1.910'
...
set firewall zone k8s-120 interface 'eth1.120'
...
set firewall zone iLO-550 interface 'eth1.550'
...
set firewall zone pve-11 interface 'eth1.11'
...
set firewall zone seccam-610 from containers firewall name 'containers-seccam-610'
set firewall zone seccam-610 interface 'eth1.610'
...
set firewall zone UISP-140 interface 'eth1.140'
...
set firewall zone transit-10 interface 'eth1.10'
...
set firewall zone ad-110 interface 'eth1.110'
...
set firewall zone bastion-410 interface 'eth1.410'
...
set firewall zone app-720 from containers firewall name 'containers-app-720'
set firewall zone app-720 interface 'eth1.720'
