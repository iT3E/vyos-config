...
set firewall zone vpn from unifi-mgmt-900 firewall name 'vpn-unifi-mgmt-900'
set firewall zone vpn from unifi-frontend-910 firewall name 'vpn-unifi-frontend-910'
set firewall zone vpn from k8s-120 firewall name 'vpn-k8s-120'
set firewall zone vpn from iLO-550 firewall name 'vpn-iLO-550'
set firewall zone vpn from pve-11 firewall name 'vpn-pve-11'
set firewall zone vpn from seccam-610 firewall name 'vpn-seccam-610'
set firewall zone vpn from UISP-140 firewall name 'vpn-UISP-140'
set firewall zone vpn from transit-10 firewall name 'vpn-transit-10'
set firewall zone vpn from ad-110 firewall name 'vpn-ad-110'
set firewall zone vpn from bastion-410 firewall name 'vpn-bastion-410'
set firewall zone vpn from app-720 firewall name 'vpn-app-720'
