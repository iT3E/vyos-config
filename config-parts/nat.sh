...
set nat destination rule 102 inbound-interface 'eth1.910'
...
set nat destination rule 103 inbound-interface 'eth1.610'
...
set nat destination rule 110 inbound-interface 'eth1.900'
...
set nat destination rule 111 inbound-interface 'eth1.910'
...
set nat destination rule 112 inbound-interface 'eth1.120'
...
set nat destination rule 113 inbound-interface 'eth1.550'
...
# set nat destination rule 114 inbound-interface 'eth1.11'
...
set nat destination rule 115 inbound-interface 'eth1.610'
...
set nat destination rule 116 inbound-interface 'eth1.140'
...
set nat destination rule 117 inbound-interface 'eth1.10'
...
#set nat destination rule 118 inbound-interface 'eth1.110'
...
#set nat destination rule 119 inbound-interface 'eth1.410'
...
set nat destination rule 120 inbound-interface 'eth1.720'
...
# set nat source rule 100 outbound-interface 'eth1.10'
