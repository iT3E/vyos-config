...
set firewall name k8s-120-pve-11 rule 2 action 'accept'
set firewall name k8s-120-pve-11 rule 2 description 'Rule: allow_9100_to_pve'
...
set firewall name vpn-mobile-containers rule 1 description 'Rule: accept_http_https_to_haproxy_authenticated'
set firewall name vpn-mobile-containers rule 1 destination group address-group 'haproxy_authenticated'
